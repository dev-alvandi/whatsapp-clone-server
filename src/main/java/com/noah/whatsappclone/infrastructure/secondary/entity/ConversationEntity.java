...
import com.noah.whatsappclone.messaging.domain.message.aggregate.ConversationBuilder;
...
public class ConversationEntity extends AbstractAuditingEntity<Long> {
    ...
    public static ConversationEntity from(Conversation conversation) {
        ...
        if (conversation.getConversationName() != null) {
            conversationEntityBuilder.name(conversation.getConversationName()
                    .name());
        }

        if (conversation.getConversationPublicId() != null) {
            conversationEntityBuilder.publicId(conversation.getConversationPublicId()
                    .value());
        }
        ...
        conversationEntityBuilder.users(UserEntity.from(conversation.getMembers()
                .stream()
                .toList()));
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getId(),
                that.getId()) && Objects.equals(getPublicId(),
                that.getPublicId()) && Objects.equals(getName(),
                that.getName()) && Objects.equals(getMessages(),
                that.getMessages()) && Objects.equals(getUsers(),
                that.getUsers());
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + Objects.hashCode(getPublicId());
        result = 31 * result + Objects.hashCode(getName());
        result = 31 * result + Objects.hashCode(getMessages());
        result = 31 * result + Objects.hashCode(getUsers());
        return result;
    }
}
